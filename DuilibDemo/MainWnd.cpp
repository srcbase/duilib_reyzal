...
void CMainWnd::OnHeaderClick(TNotifyUI& msg)
{
	...
	{
		if (iHeaderIndex == 0)
			sort(g_vecListview1Data.begin(), g_vecListview1Data.end(), [](NormalDataItem& item1, NormalDataItem& item2) {return item1.name < item2.name; });
		else if (iHeaderIndex == 1)
			sort(g_vecListview1Data.begin(), g_vecListview1Data.end(), [](NormalDataItem& item1, NormalDataItem& item2) {return item1.gender < item2.gender; });
		else if (iHeaderIndex == 2)
			sort(g_vecListview1Data.begin(), g_vecListview1Data.end(), [](NormalDataItem& item1, NormalDataItem& item2) {return item1.age < item2.age; });
		else if (iHeaderIndex == 3)
			sort(g_vecListview1Data.begin(), g_vecListview1Data.end(), [](NormalDataItem& item1, NormalDataItem& item2) {return item1.score < item2.score; });
...
bool CMainWnd::InitControl(void)
{
	...
	//listview
	m_btnAddListview1Data = static_cast<CButtonUI*>(m_PaintManager.FindControl(_T("btn_add_listview1_data")));
	m_tabListview = static_cast<CTabLayoutUI*>(m_PaintManager.FindControl(_T("tab_listview")));
	m_optListview1 = static_cast<COptionUI*>(m_PaintManager.FindControl(_T("opt_listview1")));
	m_optListview2 = static_cast<COptionUI*>(m_PaintManager.FindControl(_T("opt_listview2")));
	m_optListview3 = static_cast<COptionUI*>(m_PaintManager.FindControl(_T("opt_listview3")));
	m_optListview4 = static_cast<COptionUI*>(m_PaintManager.FindControl(_T("opt_listview4")));
	m_listNormal = static_cast<CListUI*>(m_PaintManager.FindControl(_T("list_normal")));
	m_listFix = static_cast<CListUI*>(m_PaintManager.FindControl(_T("list_fix")));
	m_listexNormal = static_cast<CListExUI*>(m_PaintManager.FindControl(_T("listex_normal")));
	m_tileSoft = static_cast<CTileLayoutUI*>(m_PaintManager.FindControl(_T("tile_soft")));
